...
export function Footer({ className }: FooterProps) {
  return (
    <footer
      className={clsx("flex flex-row justify-end py-4 px-8", className)}
      aria-labelledby="footer-heading"
    >
      {/* Copyright */}
      {false &&
      <p className="jetbrains-mono mt-8 text-base font-semibold text-gray-500 md:order-1 md:mt-0">
        &copy; 2025 Muna. All rights reserved.
      </p>
      }
...
const social = [
  {
    name: "Twitter",
    href: "https://twitter.com/usemuna",
    icon: (props: any) => (
  ...
  {
    name: "GitHub",
    href: "https://github.com/muna-ai/muna-examples",
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
