...
model = resnext101_32x8d(weights=weights).eval()

@compile(
    tag="@pytorch/resnext-101",
    description="Classify an image with ResNeXt-101 (32x8d).",
    access="public",
...
def classify(image: Image.Image) -> tuple[str, float]:
    """
    Classify an image with ResNeXt-101 (32x8d).
